...
def serialize_product(product: object) -> ProductRead:
    ...
    return ProductRead(
        ...
        image_url=resolve_public_media_url(getattr(product, "image_url", None)),
...
def serialize_store_summary(
    ...
    return StoreSummaryRead(
        ...
        logo_url=resolve_public_media_url(getattr(store, "logo_url", None)),
        cover_image_url=resolve_public_media_url(getattr(store, "cover_image_url", None)),
        status=store.status,
...
def serialize_application(application: object) -> MerchantApplicationRead:
    return MerchantApplicationRead(
        ...
        logo_url=resolve_public_media_url(getattr(application, "logo_url", None)),
        cover_image_url=resolve_public_media_url(getattr(application, "cover_image_url", None)),
