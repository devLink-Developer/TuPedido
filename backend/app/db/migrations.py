...
MERGE_RECOVERY_SCHEMA: dict[str, set[str]] = {
    ...
    "payment_providers": {"webhook_secret_encrypted", "public_key", "commission_mode", "commission_value"},
    "merchant_payment_accounts": {"scope", "live_mode", "status", "last_refresh_at", "last_refresh_error", "last_oauth_error"},
    "payment_transactions": {
        "external_reference",
