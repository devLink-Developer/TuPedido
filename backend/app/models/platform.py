...
class PlatformSettings(Base):
    ...
    platform_wordmark_url: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class PaymentProvider(Base):
    ...
    commission_mode: Mapped[str] = mapped_column(String(20), default="fixed")
    commission_value: Mapped[float | None] = mapped_column(Numeric(10, 2), nullable=True)
