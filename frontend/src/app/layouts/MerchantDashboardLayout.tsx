    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,#fcf6ef_0%,#fffdfa_100%)] text-ink">
      <div className="mx-auto flex min-h-screen max-w-[1600px] flex-col md:flex-row">
        ...
        <main className="flex-1 px-4 py-6 md:px-8">
          <header className="mb-5 flex items-center justify-between gap-3 rounded-[26px] border border-black/5 bg-white/80 px-4 py-4 shadow-sm backdrop-blur md:hidden">
            <div>
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#ffcfb7]/70">Comercio</p>
                <h2 className="mt-3 font-display text-2xl font-bold tracking-tight">Panel operativo</h2>
              </div>
              <button
                type="button"
                aria-label="Cerrar menu de comercio"
