...
export function UsersPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {actionMessage ? (
        <p className="rounded border border-emerald-200 bg-emerald-50 px-4 py-4 text-sm text-emerald-900">
          {actionMessage}
        </p>
      ) : null}
      {actionError ? (
      ...
      <div className="space-y-4">
        {filteredUsers.map((user) => (
          <article key={user.id} className="rounded bg-white p-5 shadow-sm">
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
              ...
              <div className="flex flex-wrap gap-2">
                <span className="rounded bg-zinc-100 px-3 py-1 text-xs font-semibold text-zinc-700">{roleLabels[user.role]}</span>
                <span
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              <button
                ...
                className="rounded bg-brand-500 px-4 py-2 text-sm font-semibold text-white transition disabled:cursor-not-allowed disabled:bg-zinc-300"
              >
